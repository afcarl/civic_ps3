...
The New York City Department of Transportation provides the geographic boundries of all current neighborhood slow zones in both geoJSON and shapefile formats.  In this case the geoJSON format was used.  In addition to 
